/* 
 * Trivially modified part 2 to push parameters to the stack
 * then recover them in the subroutine to the same registers 
...
_start:
	...
	PUSH	r3					 
	PUSH	r2					/* Push parameters onto the stack */
	call	SORT	
DONE:	
...
SORT:	
	POP 	r2
	POP		r3				/* Pull parameters from the stack */
	PUSH	r4
	PUSH	r5
	PUSH	r6
	PUSH	r7
